...
public:
	...
	// PA 20150919
	// The HRBF matrix is very poorly conditioned
	// Quick hack to improve this:
	// Add a regularization term (here hard coded to 1e-5)
	//
	// TODO: this should become an optional parameter to 
	// this function (with some default value)
	//
	D = D + 1e-5 * MatrixXX::Identity(D.rows(), D.cols());
